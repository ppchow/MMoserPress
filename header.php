		    ...
		    <div id="header" class="hide-for-small">
		      <div class="row">
		        <div class="medium-6 medium-push-6 columns">
		          <div class="logo"><a href="<?php echo get_bloginfo('url'); ?>"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/mmoser-logo.png" alt="<?php echo get_bloginfo('url'); ?>"></a></div>
		        </div>
